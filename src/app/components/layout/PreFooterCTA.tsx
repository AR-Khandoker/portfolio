...
export function PreFooterCTA() {
  return (
    <section className="relative py-32 border-t border-black/5 bg-white">
      {/* Background Gradient */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-black/60 max-w-2xl mb-12 leading-relaxed">
            From early-stage startups to enterprise systems, I help ambitious
            teams build high-converting, award-winning digital products.
          </p>
