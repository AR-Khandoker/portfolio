...
const MotionGraphicsPage = lazy(() =>
  import("./pages/MotionGraphicsPage").then((m) => ({
    default: m.MotionGraphicsPage,
  })),
);
const CaseStudyPage = lazy(() =>
  import("./pages/CaseStudyPage").then((m) => ({
...
const AdminProjectsPage = lazy(() =>
  import("./pages/AdminProjectsPage").then((m) => ({
    ...
    <ErrorBoundary>
      <BrowserRouter>
        <AnimatePresence mode="wait">
          {loading && (
            <BrandLoader onComplete={handleLoaderComplete} />
          )}
        </AnimatePresence>
        <MainLayout>
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route
                path="/work/motion-graphics"
                element={<MotionGraphicsPage />}
              />
              <Route
                path="/work/:id"
