      ...
      <div className="pt-32 pb-20 container mx-auto px-6 relative">
        ...
        <AnimatedSection animation="stagger" stagger={0.15}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-32">
            {services.map((service, i) => (
              <div
                key={service.title}
                className="p-8 rounded-2xl bg-black/5 border border-black/5 hover:border-black/20 transition-colors group relative"
              >
        ...
        <div className="mb-32 relative">
          <AnimatedText 
            ...
            splitBy="words" 
            stagger={0.05}
            className="text-3xl md:text-5xl font-bold mb-16 text-black"
          >
            How I Work
          </AnimatedText>
          <AnimatedSection animation="stagger" stagger={0.12}>
        ...
        {/* Pricing Cues */}
        <AnimatedSection animation="scale" duration={1}>
          <div className="bg-[#FAFAFA] rounded-3xl p-12 border border-black/5 text-center relative">
