...
// ═══════════════════════════════════════════════════════════════════════════
app.get('/make-server-89f52d09/projects', async (c) => {
  try {
...
// ═══════════════════════════════════════════════════════════════════════════
app.get('/make-server-89f52d09/projects/:id', async (c) => {
  try {
    await ensureInitialized();
...
// ═══════════════════════════════════════════════════════════════════════════
app.post('/make-server-89f52d09/projects', async (c) => {
  try {
    await ensureInitialized();
...
// ═══════════════════════════════════════════════════════════════════════════
app.put('/make-server-89f52d09/projects/:id', async (c) => {
  try {
    await ensureInitialized();
...
// Delete a project
// ═══════════════════════════════════════════════════════════════════════════
app.delete('/make-server-89f52d09/projects/:id', async (c) => {
  try {
    await ensureInitialized();
