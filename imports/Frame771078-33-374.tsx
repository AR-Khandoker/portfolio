import svgPaths from "./svg-vel4q6y4wn";
import img10Dark1 from "figma:asset/5b4230f73318bdf0c631a8f213c0c96ea3426616.png";

function Frame() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-1/2 px-[20px] py-0 top-[43px] translate-x-[-50%] w-[507px]">
...
export default function Frame1() {
  return (
    <div className="overflow-clip relative rounded-[36px] size-full">
      ...
      <div className="absolute h-[664px] left-1/2 top-[249px] translate-x-[-50%] w-[617px]" data-name="10 (dark, 1">
